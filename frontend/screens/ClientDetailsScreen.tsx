...
export default function ClientDetailsScreen({ navigation, route }: Props) {
  ...
  const executeDelete = async () => {
    console.log("🗑️ Usuário confirmou exclusão");
    setLoading(true);
    try {
      console.log("Chamando deleteClient com ID:", client.id);
      ...
      if (Platform.OS === 'web') {
        alert(`Sucesso! Cliente ${client.name} foi excluído.`);
  ...
  const handleDeleteClient = () => {
    console.log("===== handleDeleteClient CHAMADO (Details) =====");
    ...
    console.log("✅ ID válido, mostrando confirmação...");
    ...
    console.log("===== handleDeleteClient FINALIZADO =====");
  };
